...
- New callout
    ...
    * Example: dev.vsuarez.preshipment.callout.CStringFormat

- New process
    * Name: PName
    * Package: dev.vsuarez.preshipment.process
    * Example: dev.vsuarez.preshipment.process.PGenerateWithholding

- New form
    * Name: FName
    * Package: dev.vsuarez.preshipment.form
    * Example: dev.vsuarez.preshipment.form.FMultiPayment

- New event
    * Name: EName
    * Package: dev.vsuarez.preshipment.event
    * Example: dev.vsuarez.preshipment.event.EAfterCompleteInvoice

- New model (extends class X)
    * Name: MName
    * Package: dev.vsuarez.preshipment.model
    * Example: dev.vsuarez.preshipment.model.MTableExample
...
- New callout
    * Create callout in package `dev.vsuarez.preshipment.callout`, extends from `CustomCallout`
    * Register callout in `dev.vsuarez.preshipment.component.CalloutFactory`. Example:
...
- New process
    * Create process in package `dev.vsuarez.preshipment.process`, extends from `CustomProcess`
    * Register process in `dev.vsuarez.preshipment.component.ProcessFactory`. Example:
...
- New form
    * Create form in package `dev.vsuarez.preshipment.form`, extends from `CustomForm`
    * Register form in `dev.vsuarez.preshipment.component.FormFactory`. Example:
...
- New event
    * Create event in package `dev.vsuarez.preshipment.event`, extends from `CustomEvent`
    * Register event in `dev.vsuarez.preshipment.component.EventFactory`. Example:
...
- New model (extends form class X)
    * Create model in package `dev.vsuarez.preshipment.model`, extends class `X`. Example: `X_TL_TableExample -> MTableExample`
    * Register model in `dev.vsuarez.preshipment.component.ModelFactory`. Example:
